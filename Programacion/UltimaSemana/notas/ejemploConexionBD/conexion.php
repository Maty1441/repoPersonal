...
$password = ''; // Contraseña del usuario, en el XAMPP es vacío
...
$stmt = $conexion->prepare($sql); //prepare se asegura que los daots que van a ingresarse sean correctos y no tengan nada malicioso
$stmt->bind_param("sss", $nombre, $email, $password); //sss = string, string, string
